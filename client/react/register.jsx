        ...
        <div className='col-xs-12' style={{textAlign: 'center'}}>
          <form id='select-package' className='form-labels-on-top'>
            ...
            <div className='form-row' style={{display: this.state.checkedSession ? 'block' : 'none'}}>
              ...
              <div>
                <span><a style={{color: '#C0282D'}} onClick={this.toggleInvite.bind(this)}>CLICK HERE</a> and enter your <a style={{color: '#C0282D'}}>Invite Code</a> to register for a <a style={{color: '#C0282D'}}>Private Lesson</a> or <a style={{color: '#C0282D'}}>Drop-In Class</a> <br></br></span>
                <span>Still need an<a style={{color: '#C0282D'}}>Invite Code? <a onClick={() => { document.getElementById('contact-button').click() }}>CLICK HERE</a></a></span>
