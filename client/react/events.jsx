    ...
    let contents = [
      ...
      },
      {
        ...
        partial: (
          <div className='event-block' id='29MAR2026'>
            ...
            <p className='event-block-info'>
              <span className='event-block-date'>Sunday, March 29th, 2026</span><br></br>
              <span className='event-block-date'>DC Vault Pole Vault Center</span><br></br>
              <span className='event-block-date'>2200 East Capitol Street NE · Washington DC</span>
            </p>
      ...
      },
      {
        ...
        partial: (<div className='event-block' id='27JUN2026'>
            ...
            <img src = "../img/events/2026pvchamps.jpg" alt="champs" width = '350' class = "center"></img>
            <p className='event-block-info'>
      ...
      {
        date: new Date('February 1, 2026'),
        partial: (<div className='event-block' id='1FEB2026'>
            ...
            <p className='event-block-info'>
              <span className='event-block-date'>February 1, 2026</span>
              <br></br>
      ...
      },      
      {
        ...
        partial: (          <div className='event-block' id='28JUN2025'>
          ...
          <p className='event-block-info'><a href="https://polevaultchampionships.com">PoleVaultChampionships.com</a></p>
